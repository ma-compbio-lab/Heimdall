...
#             layer_constructor = FlashAttentionTransformerEncoderLayer
#             encoder_constructor = FlashAttentionTransformerEncoder
#             # try:
...
#
#         else:
#             layer_constructor = nn.TransformerEncoderLayer
#             encoder_constructor = nn.TransformerEncoder
#
#         # Encoder layers
#         encoder_layer = layer_constructor(
#             d_model=d_model,
#             nhead=nhead,
...
#         )
#         self.encoder = encoder_constructor(encoder_layer, num_layers=num_layers)
#
